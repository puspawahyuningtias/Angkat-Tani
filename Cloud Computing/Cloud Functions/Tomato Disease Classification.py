...
def disease_prediction(request):
    ...
    if not disease:
        ...
        disease = load_model("/tmp/tomato.h5")
    ...
    if (params is not None) and ('images' in params):
        ...
        if preds == 0:
            preds = "The tomato is diseased Late Blight"
        elif preds == 1:
            preds = "The tomato is diseased Leaf Mold"
        elif preds == 2:
            preds = "The tomato is diseased Mosaic Virus"
        else:
            preds = "The tomato is Healthy"
